        ...
        <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
          ...
          <section className="px-6 py-4">
            ...
            <button
              ...
              className="mt-4 w-full rounded-md border border-zinc-200 px-3 py-2 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800"
            >
              {t("settings.logout")}
            </button>
          </section>
          ...
          <section className="px-6 py-4">
            ...
            <select
              ...
              className="mt-3 h-9 w-full rounded-md border border-zinc-300 bg-white px-2 text-sm text-zinc-800 outline-none transition-colors focus:border-blue-500 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
            >
