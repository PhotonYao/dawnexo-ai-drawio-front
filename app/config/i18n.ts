...
const zh: Dict = {
  ...
  "chat.stage.analyze": "正在分析需求…",
  "chat.agent.analyst": "需求分析",
  "chat.agent.drawer": "绘图执行",
  "chat.agent.reviewer": "质检优化",
  "chat.stage.draw": "正在绘制图表…",
  "chat.stage.review": "正在优化图表…",
  "chat.welcome":
...
const en: Dict = {
  ...
  "chat.stage.analyze": "Analyzing requirements…",
  "chat.agent.analyst": "Requirement Analysis",
  "chat.agent.drawer": "Diagram Drafting",
  "chat.agent.reviewer": "Quality Review",
  "chat.stage.draw": "Drawing diagram…",
  "chat.stage.review": "Refining diagram…",
  "chat.welcome":
